...
<title>Экран редактирования телефона</title>
</head>
<body>
<%
	...
	idPhone = jsp_parameters.get("idPhone");
%>

<form action="<%=request.getContextPath()%>/" method="post">
<input type="hidden" name="id" value="<%=person.getId()%>"/>
<input type="hidden" name="phone_id" value="<%=idPhone%>"/>
    ...
    <tr>
        ...
        &nbsp;<%out.write(person.getMiddlename());%>&nbsp;</td>
    </tr>
    <tr>
        <td>Номер:</td>
        <td><input type="text" name="number" value = "<%=person.getPhones().get(idPhone)%>"/></td>
    </tr>
    <tr>
